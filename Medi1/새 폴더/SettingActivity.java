...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mediName = name.getText().toString();
        ...
        */
        ...
        for(k = 0; k < timePickID.length; k++) {
            ...
            timeSet[index].setOnClickListener(new View.OnClickListener() {
                @SuppressWarnings("deprecation")
                public void onClick(View view) {
                        AlertDialog.Builder dlg1 = new AlertDialog.Builder(SettingActivity.this);
                        dlg1.setTitle("시간선택");
            ...
            btn_save.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (name == null || startDate == null || endDate == null || timesPerDay == null || time_array[0] == null){
                        ...
                        toast1.show();
                       // Toast.makeText(SettingActivity.this, "모든 항목을 입력하세요", Toast.LENGTH_SHORT).show();
                    } else {
                        sqlDB = myHelper.getWritableDatabase();
                        sqlDB.execSQL("INSERT INTO mediTest (mediName, startDate, endDate, timesPerDay," +
                                ...
                                day_array[6] + "');");
                        sqlDB.execSQL("INSERT INTO timeTest (oneTime, twoTime, threeTime, fourTime, fiveTime) VALUES ('" +
                                time_array[0] + "', '" +
                                time_array[1] + "', '" +
                                time_array[2] + "', '" +
                                time_array[3] + "', '" +
